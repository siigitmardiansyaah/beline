...
import './xd_penilaian_kehadiran1.dart';
import './xd_penilaian_tugas1.dart';
import './xd_penilaian_ujian1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDPenilaianSiswa1 extends StatelessWidget {
  XDPenilaianSiswa1({
    Key? key,
  }) : super(key: key);
  @override
              ...
              child: PageLink(
                links: [
                  PageLinkInfo(
                    ...
                    ease: Curves.easeOut,
                    duration: 0.3,
                    pageBuilder: () => XDPenilaianKehadiran1(),
                  ),
                ],
                child: Stack(
                  children: <Widget>[
