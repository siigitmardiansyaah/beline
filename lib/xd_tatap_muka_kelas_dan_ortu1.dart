...
import './xd_exit_video_meet.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:adobe_xd/pinned.dart';
import './xd_dashboard_guru.dart';
import './xd_video_meeting_siswa1.dart';
import './xd_video_meeting_orang_tua1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDTatapMukaKelasDanOrtu1 extends StatelessWidget {
  XDTatapMukaKelasDanOrtu1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              child: PageLink(
                links: [
                  PageLinkInfo(
                    ...
                    ease: Curves.easeOut,
                    duration: 0.3,
                    pageBuilder: () => XDVideoMeetingSiswa1(),
                  ),
                ],
                child: Stack(
                  children: <Widget>[
              ...
              child: PageLink(
                links: [
                  PageLinkInfo(
                    ...
                    ease: Curves.easeOut,
                    duration: 0.3,
                    pageBuilder: () => XDVideoMeetingOrangTua1(),
                  ),
                ],
                child: Stack(
                  children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 251.0, start: 62.0),
            Pin(size: 31.0, middle: 0.5301),
            child: Text(
              'Tatap Muka Orang Tua',
              style: TextStyle(
                fontFamily: 'Alata',
                fontSize: 23,
                color: const Color(0xffffffff),
