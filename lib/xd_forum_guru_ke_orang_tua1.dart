...
class XDForumGuruKeOrangTua1 extends StatelessWidget {
  XDForumGuruKeOrangTua1({
    Key? key,
  }) : super(key: key);
  @override
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: const AssetImage('assets/images/forum_ortu_guru.png'),
                fit: BoxFit.fill,
              ),
            ),
          ),
...
'assets/images/Kirim Tugas-18.svg';
const String _svg_qlli =
'assets/images/Emoji (forum kelas)-17.svg';
const String _svg_c8bwih =
    '<svg viewBox="30.0 0.0 246.0 61.0" ><path transform="translate(30.0, 0.0)" d="M 0 0 L 246 0 L 246 61 L 0 61 Z" fill="#ffffff" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
